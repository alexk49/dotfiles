...
require("lazy").setup({
	...
	"christoomey/vim-tmux-navigator", -- allow tmux and vim navigation with same keys

	"tpope/vim-surround", -- adds extra html wrappers
	...
	{
		"mattn/emmet-vim",
		ft = { "html", "css" }, -- Lazy-load only for HTML/CSS files
		init = function()
...
-- Toggle spell checker with underline for misspelled words
vim.keymap.set("n", "<leader>s", function()
...
end, { desc = "Toggle spell checker", silent = true })
